...
/**
 * Class tool_carcastc\event\row_viewed
 *
...
/**
 * Class to create event when row is viewed
 *
 * @package    tool_carcastc
 * @copyright  2021, Carlos Castillo <carlos.castillo@moodle.com>
...
class row_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventrowviewed', 'tool_carcastc');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' view the rows associated with course id '$this->courseid'.";
    }
