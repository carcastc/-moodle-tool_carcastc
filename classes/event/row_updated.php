...
/**
 * Class tool_carcastc\event\row_updated
 *
...
/**
 * Class to create event when row is updated
 *
 * @package    tool_carcastc
 * @copyright  2021, Carlos Castillo <carlos.castillo@moodle.com>
...
class row_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventrowupdated', 'tool_carcastc');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the row with id '$this->objectid'
