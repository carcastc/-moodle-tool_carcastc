...
/**
 * Class tool_carcastc\event\row_created
 *
...
/**
 * Class to create event when row is created
 *
 * @package    tool_carcastc
 * @copyright  2021, Carlos Castillo <carlos.castillo@moodle.com>
 * @license    http://www.gnuZc.org/copyleft/gpl.html GNU GPL v3 or later
 */
class row_created extends base {

    /**
     * Set initial config for created event.
     * @return void
     */
    ...
    public static function get_name() {
        return get_string('eventrowcreated', 'tool_carcastc');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the row with id '$this->objectid'
